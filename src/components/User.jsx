    ...
    return (
        <div className='lg:py-[60px] relative pt-10 pb-5'>
            <div className='container mx-auto xl:max-w-[1164px] px-3'>
                <div className="sm:max-w-[1036px] max-w-[430px] mx-auto pt-[36px] pb-[35px] border border-solid border-[#FFFFFF29] bg-[url('./assets/images/png/bg-user.png')] bg-cover bg-center bg-no-repeat rounded-3xl flex items-center lg:justify-between justify-center flex-wrap relative">
