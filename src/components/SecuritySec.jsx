...
const SecuritySec = () => {
    return (
        <div className='lg:pt-[87px] lg:pb-[79px] md:py-[60px] py-11'>
            <div className='container mx-auto xl:max-w-[1164px] px-3 relative z-10'>
                <div className='flex lg:justify-between justify-center flex-col-reverse lg:flex-row items-center flex-wrap'>
                    <div className='lg:w-[46%] w-full lg:mt-0 md:mt-10 mt-7'>
                    ...
                    <div className='lg:w-[48%] md:w-[70%] w-full'>
