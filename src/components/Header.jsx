            ...
            <div className='bg-[#12121299] w-full'>
                <div className='sm:px-[40px] px-3 sm:py-[22.8px] mx-auto py-4 flex items-center justify-between w-full 2xl:max-w-[1440px]'>
                    ...
                    <div className='flex items-center lg:gap-10 sm:gap-6 gap-4'>
                        <ul className={`${nav ? "left-[-100%]" : "left-0"} flex max-lg:fixed max-lg:top-0 max-lg:h-full z-40 max-lg:w-full max-lg:z-20 max-lg:transition-all max-lg:duration-300 max-lg:ease-linear max-lg:bg-[#121212f9] max-lg:min-h-screen max-lg:flex-col gap-[32px] items-center justify-center`}>
