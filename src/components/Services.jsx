...
const Services = () => {
    return (
        <div id='product' className="lg:mt-10 md:mt-7 sm:mt-5 mt-3 bg-[url('./assets/images/webp/bg-services.webp')] bg-cover bg-center bg-no-repeat relative">
            ...
            <div className='container mx-auto xl:max-w-[1164px] px-3 xl:pt-[114px] xl:pb-[113px] md:py-[60px] sm:py-10 py-[20px] relative z-20'>
                <h2 data-aos="zoom-in" className='sm:text-[48px] text-[33px] font-normal leading-[120%] text-white text-center md:mb-4 mb-3'>Our <span className='text-[#BAFF00] '>Services</span></h2>
                <p data-aos="zoom-in" className='text-[16px] font-normal text-center text-white leading-[150%]'>Dolor ipsum facilisi facilisis diam mi dis. Et gravida porta quam risus consectetur est <span className='lg:block'>imperdiet. Enim feugiat nisl dolor dui est. </span></p>
                <div data-aos="zoom-in" className='flex lg:justify-between justify-center lg:gap-0 gap-4 flex-wrap lg:items-start items-center md:mt-10 mt-6 relative z-20'>
                    <div className='lg:w-[32.3%] md:w-[48%] sm:w-[80%] w-full relative z-10'>
                        <div className="md:min-h-[318px] h-full border border-solid border-[#FFFFFF29] bg-[url('./assets/images/webp/service-box-image.webp')] bg-center bg-cover bg-no-repeat sm:py-10 py-7 rounded-[16px] px-[18px] flex items-center justify-start flex-col pl-[18px] pr-[22px] backdrop-blur-[20px] transition-all duration-300 ease-linear group hover:border-[#BAFF00] cursor-pointer">
                            <PentestImg />
